...
export const T = {
  fr: {
    ...
    catTracked:    'SUIVIS',
    catGps:        'GPS/GNSS',
    catStarlink:   'STARLINK',
    catWeather:    'MÉTÉO',
    catStations:   'STATIONS',
    catScience:    'SCIENCE',
    catTelephonie: 'TÉLÉPHONIE',
    catInternet:   'INTERNET',
    catDebris:     'DÉBRIS',
    catStation:    'STATIONS',
    hintBar:       'GLISSER · TOURNER  |  MOLETTE · ZOOM  |  CLIC · SÉLECT.',
    // Panneaux satellites
    layerStation:   'STATIONS',
    layerGps:       'GPS / GNSS',
    layerWeather:   'MÉTÉO',
    layerScience:   'SCIENCE',
    layerStarlink:  'STARLINK',
    layerTelephonie:'TÉLÉPHONIE',
  },
  en: {
    settings:      'SETTINGS',
    region:        'REGION & TIME',
    ...
    catStations:   'STATIONS',
    catScience:    'SCIENCE',
    catTelephonie: 'TELECOM',
    catInternet:   'INTERNET',
    catDebris:     'DEBRIS',
    catStation:    'STATIONS',
    hintBar:       'DRAG · ROTATE  |  SCROLL · ZOOM  |  CLICK · SELECT',
